...
class MyTextFieldPrefixSuffix extends StatefulWidget {
  ...
  @override
  _MyTextFieldPrefixSuffixState createState() =>
      _MyTextFieldPrefixSuffixState();
}
    ...
    var container = Container(
      ...
      decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: isFocused
                  ? widget.focusedColor.withOpacity(.1)
          ...
          border: Border.all(
              color: isFocused ? widget.focusedColor : widget.outlineColor,
              width: 1)),
      child: Row(
        children: [
          ...
          Expanded(
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                labelStyle: Style.normal
                    .copyWith(fontSize: 24, color: widget.focusedColor),
